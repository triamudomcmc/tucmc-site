...
export const Positions: Record<string, PositionData> = {
  GeneralCommittee: {
    ...
    job_description: [
      "ประสานงานภายในองค์กร กับนักเรียน ชมรม และหน่วยงานต่าง ๆ ในโรงเรียน",
      "จัดทำเอกสารต่าง ๆ เช่น เอกสารข้อกำหนด เอกสารสรุปงาน",
      "ร่วมวางแผนงาน วางแผนกรอบเวลา และขอบเขตของการทำงาน",
      "คิดคอนเทนต์สำหรับกิจกรรมตามแต่ละโอกาส",
      "ทำงานต่าง ๆ ที่ได้รับมอบหมาย"
    ],
    requirements: [
      "เป็นนักเรียนชั้น ม.4 หรือ ม.5 ในปีการศึกษา 2568",
    ...
    FAQ: [
      {
        question: "งานของกรรมการกลางง่ายที่สุดไหม มีเวลาว่างมากกว่าตำแหน่งอื่นหรือเปล่า ?",
        answer:
          "เนื่องจากเราทำงานเป็นองค์กร ทำให้ทุกตำแหน่งมีงานของตัวเองอยู่ตลอดเวลา แต่ความยากง่ายนั้นจะเปลี่ยนไปตามงานต่าง ๆ ที่ได้รับมอบหมาย"
      },
      {
        question: "กรรมการกลางเป็นตำแหน่งที่ขอบเขตการทำงานกว้าง ไม่มีหน้าที่หรือทักษะที่ต้องการชัดเจนเหมือนตำแหน่งอื่น ๆ การคัดเลือกจะใช้เกณฑ์อะไรในการคัด ?",
        answer:
          "เราจะคัดเลือกจากทัศนคติเชิงบวกของผู้สมัครต่อการทำงานในการพัฒนาองค์กร ความกระตือรือร้นในการคิดริเริ่มสร้างสรรค์ ที่สำคัญคือ Hard skills และ Soft skills ของผู้สมัคร ซึ่งถือเป็นความโดดเด่นเฉพาะตัวของผู้สมัคร สามารถนำมาต่อยอดในการทำงานได้"
      },
      {
        question: "ตำแหน่งกรรมการกลางเป็นตำแหน่งที่มีคนจำนวนมากและมีคนหลากหลาย การทำงานจะเกิดปัญหาในการแบ่งหน้าที่หรือการประสานงานหรือไม่ ?",
        answer:
          "การทำงานของกรรมการกลาง หลังจากที่ประชุมงานกันแล้ว ส่วนมากจะแบ่งงานกันตามความถนัดและความสนใจของแต่ละคน หากใครต้องการความช่วยเหลือก็จะมีเพื่อน ๆ คอยช่วยเหลือเสมอ อีกทั้งเราเน้นให้มีการสื่อสารภายในองค์กรตลอดเวลา เพื่อให้เกิดความสบายใจในการทำงาน และสามารถแสดงความเป็นตัวเองผ่านผลงานต่าง ๆ ของ กช. ได้"
      },
      {
      ...
      },
      {
        ...
        answer:
          "งานที่ได้รับมอบหมายมีหลายประเภท เช่น การทำเอกสาร การวางแผนงาน คิดคอนเทนต์ ประสานงานกับชมรม องค์กรนักเรียน และองค์กรภายในโรงเรียน ถ่ายคลิปวิดีโอประชาสัมพันธ์ วางแผนการขายสินค้า การจัดการเวที ควบคุมการถ่ายทอดสด ฯลฯ"
      }
    ],
    reviews: [
      {
  ...
  Secretary: {
    ...
    job_description: [
      ...
      "จัดทำสรุปประชุมให้กับประธานชมรมและหน่วยงานต่าง ๆ ในโรงเรียน",
      "ตรวจสอบเนื้อหาก่อนเผยแพร่ในรูปแบบต่าง ๆ ของ กช.",
      "ทำงานร่วมกับตำแหน่งกรรมการกลาง"
    ],
    requirements: [
      "เป็นนักเรียนชั้น ม.4 หรือ ม.5 ในปีการศึกษา 2568",
      ...
      "มีทักษะด้านการสื่อสาร การใช้ภาษาไทย และการเลือกใช้ระดับภาษาให้เหมาะสมกับงานและบุคคลได้อย่างดีเยี่ยม",
      "มีความมุ่งมั่นในการทำงาน ละเอียด และรอบคอบ  สามารถตรวจสอบเนื้อหาและพิสูจน์อักษรได้อย่างดีเยี่ยม",
      "มีคุณสมบัติที่เหมือนกับตำแหน่งกรรมการกลาง"
    ],
    FAQ: [
      {
      ...
      {
        question: "งานของเลขาที่ต้องทำร่วมกับกรรมการกลางมีอะไรบ้าง ?",
        answer:
          "เลขานุการถือเป็นส่วนหนึ่งของกรรมการกลาง จึงต้องเข้าร่วมการประชุมของกรรมการกลางทุกครั้ง เพื่อร่วมวางแผนงานและทำงานต่าง ๆ ตามที่ได้รับมอบหมาย โดยจะเน้นงานเอกสารเป็นหลัก"
      }
    ],
    reviews: [
      {
  ...
  GraphicDesigner: {
    ...
    job_description: [
      "จัดทำโพสต์เผยแพร่ผ่านช่องทางของ กช. เช่น Instagram, Facebook",
      "จัดทำสื่อประชาสัมพันธ์ต่าง ๆ เช่น อินโฟกราฟิก เว็บไซต์ โปสเตอร์กิจกรรม ป้ายบอกทาง",
      "ออกแบบสิ่งต่าง ๆ ตามที่ได้รับมอบหมาย เช่น ของรางวัลในงาน Triam Udom Open House 2023",
      "ทำคอนเทนต์อื่น ๆ เพิ่มเติมตามความสนใจ เช่น Giveaway, Planner"
    ],
    requirements: [
      "เป็นนักเรียนชั้น ม.4 หรือ ม.5 ในปีการศึกษา 2568",
      ...
      "มีความขยัน อดทน และไม่ย่อท้อ สามารถทำงานเสร็จทันตามเวลาที่กำหนด"
    ],
    note: "**มีการคัดเลือกจากผลงานและการทำโจทย์คัดเลือก**",
    FAQ: [
      {
        question: "กราฟิกดีไซเนอร์ ต้องมีทักษะในการทำ Graphic รูปแบบไหนถึงจะสมัครได้ ?",
        answer:
          "เราเปิดรับผู้ที่มีทักษะและความถนัดในการทำ Graphic ที่หลากหลาย เช่น Illustration, Cartoon Drawing, Web Design, Typography, Collage, 3D, Visual Design, Layout, Animation, Motion Design ฯลฯ"
      },
      {
        question: "งานหนักไหม ?",
      ...
      {
        question:
          "ถ้าไม่เคยออกแบบเว็บไซต์มาก่อน แต่มีพื้นฐานด้าน Graphic design อื่น ๆ สามารถสมัครได้ไหม ? ",
        answer:
          "ได้ ! ทักษะการออกแบบเว็บไซต์มีความใกล้เคียงกับการออกแบบ Graphic ทั่วไป นอกจากนี้ ยังมีคนช่วยสอนวิธีการใช้และออกแบบเว็บไซต์เบื้องต้นเพื่อฝึกฝนให้ทุกคนลงมือทำงานจริงได้ "
      },
      {
        question: "งานหลัก ๆ ที่จะต้องทำมีอะไรบ้าง ?",
        answer:
          "มีการจัดทำโพสต์เพื่อการประชาสัมพันธ์บน Instagram และ Facebook จัดทำอินโฟกราฟิก นอกจากนี้ยังมีการออกแบบผลิตภัณฑ์ต่าง ๆ ไม่ว่าจะเป็นไวนิล ป้ายชื่อ ของรางวัล และอื่น ๆ อีกมากมาย"
      },
      {
        question:
  ...
  PR: {
    ...
    job_description: [
      ...
      "ดูแลรับผิดชอบพิธีกรในงานต่าง ๆ ของ กช.",
      "ดูแลรับผิดชอบแพลตฟอร์มการประชาสัมพันธ์ของ กช.",
      "ตรวจสอบความถูกต้องของเนื้อหาก่อนเผยแพร่ในช่องทางการประชาสัมพันธ์ของ กช."
      ,"วางแผนการประชาสัมพันธ์งานต่าง ๆ ของ กช. ร่วมกับตำแหน่งกราฟิกดีไซเนอร์และกรรมการกลาง"
    ],
    requirements: [
      "เป็นนักเรียนชั้น ม.4-5 ในปีการศึกษา 2568",
  ...
  IT: {
    ...
    requirements: [
      "เป็นนักเรียนชั้น ม.4-6 ในปีการศึกษา 2568",
