  ...
  PR: {
    ...
    FAQ: [
      ...
      },
      {
        ...
        answer:
          "ไม่ ตำแหน่งประชาสัมพันธ์จะแบ่งงานเป็น 2 ส่วน คือ ส่วนที่ 1 งานประจำตำแหน่ง เช่น พิธีกร อินเตอร์คอม งานส่วนนี้เราต้องทำด้วยตนเอง ส่วนที่ 2 จะเป็นงานทั่วไปเช่น การวางแผนประชาสัมพันธ์ และงานทั่วไปอื่น ๆ ซึ่งต้องทำงานร่วมกับ กช. ทุกคน"
      }
    ],
    reviews: [
      {
