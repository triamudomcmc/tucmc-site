    ...
    >
      <div className="flex min-h-screen flex-col pb-8">
        ...
        <section className="announcement-section py-6">
          <AnnouncementSection
            title="Giveaway: ตารางสอบ Final 1/2565"
            body={
              <div>
                <p>🎲 Final นี้มาเล่น Gacha สุ่มดวงชะตากัน !</p>
                <p>Giveaway ★ ตารางสอบ Final 1/2565 ★ พร้อมใช้งานแล้ว สามารถดาวน์โหลดได้ที่ลิงก์บน bio หรือสแกน QR code ในรูปถัดไปได้เลย *. ⋆</p>
                <p>Gacha ของ กช. รอให้ทุกคนมากดใช้อยู่นะ</p>
                <p>👇 จิ้มรายละเอียดได้ที่ลิงก์ด้านล่างเลย~</p>
              </div>
            }
            actionText="ตารางสอบ"
            imgSrc={announcementSrc}
            href="https://drive.google.com/drive/folders/17ZnYTHvQUEfH2sh71DLfeRLGSxBOItz2?usp=sharing"
          />
        </section>
