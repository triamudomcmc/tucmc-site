    ...
    >
      <div className="flex min-h-screen flex-col pb-8">
        ...
        <section className="announcement-section py-6">
          <AnnouncementSection
            title="ระบบลงทะเบียนชมรม ปีการศึกษา 2569"
            body={
              <div>
                <p>
                  {" "}
                  ⁺◦ ระบบลงทะเบียนชมรมจะเปิดในวันที่ 18 พฤษภาคม เวลา 12.00 น. และสามารถลงทะเบียนได้ถึงวันที่ 22 พฤษภาคม
                  เวลา 23.59 น. ´ˎ˗
                </p>
                <br />
                <p>
                  ✧ นักเรียน ม.4 จะต้องสร้างบัญชีเพื่อเข้าสู่ระบบ
                  <br />✧ นักเรียน ม.5 และ ม.6 ให้ใส่ชื่อผู้ใช้และรหัสผ่านเพื่อเข้าสู่ระบบเดิม
                </p>
                <br />
